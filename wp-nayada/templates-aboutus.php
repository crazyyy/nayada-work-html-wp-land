...
<article class="aboutus">
	<div class="inner">
		<h6><?php the_title(); ?></h6>
			...
			<a href="<?php the_field( "sertificate_big" ); ?>" class="sertificate"><img src="<?php the_field( "sertificate_small" ); ?>" alt=""><span></span></a>
			...
			<ul class="avards clearfix">
		        ...
		        ?>
				<li><a href="<?php echo $awards_img_big; ?>"><img src="<?php echo $awards_img_small; ?>" alt=""></a></li>
	    		<?php endwhile; ?>
	    	</ul><!-- avards -->
	    	<?php endif; ?>
